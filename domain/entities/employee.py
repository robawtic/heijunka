# heijunka/domain/entities/employee.py
...
class Employee:
    ...
    def is_available_for_period(self, date_obj: date, period: Optional[int] = None) -> bool:
        ...
        for av in self._available_periods:
            ...
            # If this is a call-in or ARO record for this date, employee is unavailable
            if av.is_call_in or av.is_aro:
                return False

            # If this is a partial availability record for the specific period, employee is unavailable
            if av.is_partial and period is not None and av.period == period:
                return False

            # If this is an offline record for the specific period, employee is unavailable
            if av.is_offline and period is not None and av.period == period:
                return False
