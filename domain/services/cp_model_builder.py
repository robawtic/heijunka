...
class CPModelBuilder:
    def build_model(self, employees: List[Employee], workstations: List[Workstation], 
                   period: int, team_id: int, aro_data: Dict) -> cp_model.CpModel:
        """
        ...
        Returns:
            A CP model with all variables and constraints defined
        """
        # Create CP model
    ...
    def solve_one_period(self, employees: List[Employee], workstations: List[Workstation],
                        ...
                        aro_data: Dict) -> List[WorkAssignment]:
        """
        ...
        try:
            # Build the model
            model, assign = self.build_model(employees, workstations, period, team_id, aro_data)
