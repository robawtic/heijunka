# domain/services/schedule_recalculation_handler.py
from typing import Dict, Any, Optional
from datetime import date

from domain.events import AROAssignmentCreated, AROAssignmentRemoved, AROAssignmentUpdated
from domain.repositories.interfaces import employee_repository, workstation_repository
...
class ScheduleRecalculationHandler:
    ...
    def __init__(self,
        ...
        Args:
            ...
            workstation_repository: Repository for accessing workstation information
    ...
    def _recalculate_schedules(self,
        ...
        """
        # Get the teams
        from_team = self.team_repository.get_by_id(from_team_id)
        to_team = self.team_repository.get_by_id(to_team_id)
    ...
    def _recalculate_team_schedule(self,
        ...
        # Retrieve employees and workstations for the team
        employees = self.employee_repository.get_by_team_id(team_id)
        workstations = self.workstation_repository.get_by_team_id(team_id)

        # Use the default periods per day (from config or ScheduleService)
        periods_per_day = getattr(self.schedule_service, "DEFAULT_PERIODS_PER_DAY", 4)

        # Call the schedule service to generate the schedule
