...
class TestRegistry(unittest.TestCase):
    ...
    def test_get_rules_for_team_with_team(self):
        ...
        with patch('domain.rules.registry.TEAM_RULES', {'testteam': [lambda ctx: None]}):
    ...
    def test_create_context_for_team_headsub(self):
        ...
        # Add aro_data to context parameters
        context_params = self.context_params.copy()
        aro_data = {"employee1": [{"period": 1, "to_team_id": 2}]}
        context_params['aro_data'] = aro_data

        ctx = create_context_for_team('headsub', **context_params)
        ...
        self.assertEqual(ctx.aro_data, aro_data)
    ...
    def test_create_context_for_team_other(self):
        ...
        ctx = create_context_for_team('otherteam', **context_params)
